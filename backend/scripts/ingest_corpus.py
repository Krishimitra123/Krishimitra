...
DOCUMENT_MANIFEST = [
    {
        ...
        'source_doc': 'ICAR Organic Farming eCourse (TNAU)',
        'category': 'organic_foundations',
        'crop_tag': None,
        'zone_tag': None,
        'language': 'en',
    },
    ...
    {
        'path': 'corpus/raw/ZBNF_Research_Paper.pdf',
        'source_doc': 'Zero Budget Natural Farming Research Paper (ResearchGate 2022)',
    ...
    },
    {
        ...
        'source_doc': 'NIPHM IPM Package for Rice',
    ...
    {
        'path': 'corpus/raw/Karnataka_Soil_Zones.json',
        'source_doc': 'Karnataka Agro-Climatic Zones Soil Fertility Data',
        'category': 'soil_fertility',
        'crop_tag': None,
        'zone_tag': None,
        'language': 'en',
    },
    # ADD MORE DOCUMENTS HERE AS YOU COLLECT THEM
]
